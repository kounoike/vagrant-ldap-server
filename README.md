...
OpenLDAPのダメダメ設定のダメっぷりを示すVagrant一式です。どのくらいダメかというと、*ローカルユーザがrootになれる*くらいにダメダメです。詳細は[こーのいけのぶろぐ？：OpenLDAPのダメダメ設定のダメっぷりを示す ](http://www.typemiss.net/2014/09/openldap.html)にて公開予定です。
